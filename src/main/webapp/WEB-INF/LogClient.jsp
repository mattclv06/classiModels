...
<meta name="description"
	content="Ta description, ne pas depasser 155 caracteres">
</head>
<!-- ---------------------------------------------------NAVBAR---------------------------------------- -->
<body>
	<!-- Naaaaaaaaaaaaaaav  -->
	...
	<footer
		class="page-footer text-center font-small mt-4 wow fadeIn couleurFramboise">
	...
	<script type="text/javascript"
		src=" <c:url value="./js/scriptco.js" />"></script>
	<script
